      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
              <div class="sidebar-toggle-box">
                  <div class="fa fa-bars tooltips dark" data-placement="right" data-original-title="Toggle Navigation"></div>
              </div>
...
<div class="nav notify-row" id="top_menu">
                ...
                <ul class="nav top-menu">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="index.html#">
                            ...
                            <span class="badge bg-theme"> <?php user_reply_counter(); ?> </span>
                        </a>
                        <ul class="dropdown-menu extended inbox">
                            <div class="notify-arrow notify-arrow-green"></div>
                            <li>
                                <p class="green">You have <?php user_reply_counter();  ?> new replies(s)</p>
                            </li>
                           
                            <?php user_reply_dropdown(); ?>
                            
                            
                            <li>
                                <a href="all_request.php" target="frame" class="text-center">See all Replies</a>
                            </li>
                        </ul>
                    </li>
                    <!-- inbox dropdown end -->
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                 <form method="POST" action="others.php" class="up">
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <h5 class="centered"><?php echo $_SESSION['first_name']; echo " "; echo $_SESSION['last_name']; ?></h5>
                        ...
                        <li class="mt">
                      <a  class="" href="request_form.php" target="frame">
                ...
                <li>
                      <a  class="" href="request_status.php" target="frame">
                  ...
                  <li >
                      <a  class="" href="all_request.php" target="frame">
                          <i class="fa fa-th"></i>
                  ...
                  <li>
                      <a  class="" href="history.php" target="frame">
